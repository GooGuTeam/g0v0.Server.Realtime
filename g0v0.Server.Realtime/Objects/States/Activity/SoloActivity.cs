...
/// <summary>
/// Represents a user playing a solo game.
/// </summary>
public class SoloActivity : IUserActivity
{
    /// <inheritdoc />
    public UserActivityType Type => UserActivityType.Solo;
    ...
    {
        return $"Playing {BeatmapDisplayTitle}";
    }

    /// <inheritdoc />
    public UserActivity? ToLazer()
    {
        return new UserActivity.InSoloGame()
        {
            BeatmapID = BeatmapId,
